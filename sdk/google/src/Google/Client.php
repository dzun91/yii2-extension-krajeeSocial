...
$path = __DIR__ . '/../';
require_once $path . 'Google/Auth/AssertionCredentials.php';
require_once $path . 'Google/Cache/File.php';
require_once $path . 'Google/Cache/Memcache.php';
require_once $path . 'Google/Config.php';
require_once $path . 'Google/Collection.php';
require_once $path . 'Google/Exception.php';
require_once $path . 'Google/IO/Curl.php';
require_once $path . 'Google/IO/Stream.php';
require_once $path . 'Google/Model.php';
require_once $path . 'Google/Service.php';
require_once $path . 'Google/Service/Resource.php';
