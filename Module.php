...
namespace extensions\krajeeSocial;
...
class Module extends \yii\base\Module
{
    ...
    /**
     * @var object the Google API object
     * @author DungNV
     */
    private $_googleAPI;
    
    /**
     * Returns the Google SDK API object
     *
     * @throws InvalidConfigException
     * @author DungNV
     */
...
//        $communityId  = null;
        ...
        if ($clientId == null) {
            throw new InvalidConfigException("The Google 'clientId' has not been set.");
        }
        
        if ($secret == null) {
            throw new InvalidConfigException("The Google 'clientSecret' has not been set.");
        }

        if (!isset($this->_googleAPI)) {
            require_once('sdk/google/src/google/Client.php');
            
            $this->_googleAPI = new \Google_Client();
            $this->_googleAPI->setClientId($clientId);
            $this->_googleAPI->setClientSecret($secret);
        }
